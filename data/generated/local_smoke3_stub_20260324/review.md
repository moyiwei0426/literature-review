...
- The appendix records 3 papers and 6 matrix rows used to generate the review synthesis.
...
- **Modeling pedestrians’ road crossing behavior in traffic system** (2006) | Methods: pipeline, llm-assisted-extraction | Tasks: literature review, information extraction | Gap matches: e3ceb20c-9aef-4214-b4d6-e84da48999fb
- **crosswalks and a pedestrian user survey which sought pedestrian perceptions toward various pedestrian** (2003) | Methods: pipeline, llm-assisted-extraction | Tasks: literature review, information extraction | Gap matches: e3ceb20c-9aef-4214-b4d6-e84da48999fb
- **Untitled** (2001) | Methods: pipeline, llm-assisted-extraction | Tasks: literature review, information extraction | Gap matches: e3ceb20c-9aef-4214-b4d6-e84da48999fb

### Gap Index

- **e3ceb20c-9aef-4214-b4d6-e84da48999fb** (n/a): The current literature set shows weak metric reporting, limiting rigorous cross-paper evaluation. Research need: common evaluation protocols and explicit metric reporting conventions that let future reviews compare outcomes on the same scale.
